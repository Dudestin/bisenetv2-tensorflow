...
# @File    : segcomp_tf_io.py
# @IDE: PyCharm
"""
Segcomp tensorflow dataset io module
"""
import os
...
from local_utils.augment_utils.segcomp import augmentation_tf_utils as aug
...
class _CityScapesTfWriter(object):
            ...
            for sample_path in sample_image_paths:
                ...
                example = tf.train.Example(
                    features=tf.train.Features(
                        feature={
                            'gt_src_image_raw':
                            _bytes_list_feature(gt_image_raw),
                            'gt_label_image_raw':
                            _bytes_list_feature(gt_label_image_raw),
                        }))
    ...
    def write_tfrecords(self):
        ...
        train_tfrecords_file_name = 'segcomp_train.tfrecords'
        ...
        val_tfrecords_file_name = 'segcomp_val.tfrecords'
...
class _CityScapesTfReader(object):
    ...
    def __len__(self):
        ...
        :return:
        """
        tfrecords_file_paths = ops.join(self._tfrecords_dir, 'segcomp_{:s}.tfrecords'.format(self._dataset_flags))
