...
# @File    : timeprofile_segcomp_bisenetv2.py
# @IDE: PyCharm
"""
...
PB_FILE_PATH = './checkpoint/segcomp/bisenetv2_segcomp_frozen.pb'
ONNX_MODEL_FILE_PATH = './checkpoint/segcomp/bisenetv2_segcomp_frozen.onnx'
TRT_ENGINE_FILE_PATH = './checkpoint/segcomp/bisenetv2_segcomp_frozen.trt'


LABEL_CONTOURS = [(0, 0, 0),  # 0=Car
                  # 1=Bus, 2=Truck, 3=SVehicle, 4=Pedestrian, 5=Motorbike
                  (193, 214, 0), (180, 0, 129), (255, 121, 166), (255, 121, 166), (255, 0, 0),
                  ...
                  # 16=train, 17=motorcycle, 18=bicycle, 19=others, 20=own
