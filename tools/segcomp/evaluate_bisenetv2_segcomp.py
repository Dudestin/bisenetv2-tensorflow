...
# @File    : evaluate_bisenetv2_segcomp.py
# @IDE: PyCharm
"""
Evaluate bisenetv2 model in segcomp dataset
"""
...
CFG = parse_config_utils.segcomp
...
def init_args():
    ...
    parser.add_argument('-d', '--dataset_dir', type=str, help='The dataset dir',
                        default='./data/example_dataset/segcomp')
...
class MultiScaleEvaluator(object):
    ...
    def __init__(self, pb_file_path, dataset_dir, min_scale=0.75, max_scale=2.0, scale_step=0.25,
        ...
        self._input_tensor_size = [int(tmp / 2) for tmp in crop_size]
